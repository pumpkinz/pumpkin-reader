...
public class ActionUtil {
    ...
    public static void save(final Context ctx, final Menu menu, final News news) {
        ...
        CoordinatorLayout layout =
            (CoordinatorLayout) ((Activity) ctx).findViewById(R.id.news_detail_layout);

        Snackbar sb =
            Snackbar.make(layout, isNewsSaved ? R.string.unsaved_news : R.string.saved_news,
    ...
    public static void share(Context ctx, News news) {
        ctx.startActivity(Intent.createChooser(getPumpkinShareIntent(news),
            ctx.getResources().getString(R.string.share)));
    }
